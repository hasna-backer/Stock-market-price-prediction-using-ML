...
public class userviewbookmarks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userviewbookmarks);
        ...
        String url = "http://" + hu + ":8000/WMS/viewmybookmarks/";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lv.setAdapter(new custom_view_bookmarks(getApplicationContext(),stock,content,id));
                            }
                            else {
